...
class TestBeatStateSpaceClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        # dtypes
        self.assertTrue(bss.intervals.dtype == np.int64)
        self.assertTrue(bss.state_positions.dtype == np.float64)
        self.assertTrue(bss.state_intervals.dtype == np.int64)
        self.assertTrue(bss.first_states.dtype == np.int64)
        self.assertTrue(bss.last_states.dtype == np.int64)
...
class TestMultiPatternStateSpaceClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        # dtypes
        self.assertTrue(mpss.state_positions.dtype == np.float64)
        self.assertTrue(mpss.state_intervals.dtype == np.int64)
...
class TestBeatTransitionModelClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertTrue(tm.probabilities.dtype == np.float64)
        self.assertTrue(tm.log_probabilities.dtype == np.float64)
...
class TestRNNBeatTrackingObservationModelClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertTrue(self.om.densities(self.obs).dtype == np.float64)
        self.assertTrue(self.om.log_densities(self.obs).dtype == np.float64)
