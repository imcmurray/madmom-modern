...
class TestAdjustGainFunction(unittest.TestCase):
    ...
    def test_types(self):
        ...
        # same with int dtype
        result = adjust_gain(sig_2d.astype(np.int64), 0)
        self.assertTrue(len(result) == len(sig_2d))
        self.assertTrue(result.shape == sig_2d.shape)
    ...
    def test_values(self):
        ...
        # same with int dtype
        result = adjust_gain(sig_1d.astype(np.int64), 0)
        self.assertTrue(np.allclose(result, sig_1d.astype(np.int64)))
        result = adjust_gain(sig_1d.astype(np.int64), -5)
...
class TestAttenuateFunction(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertTrue(result.dtype == sig_2d.dtype)
        # same as int dtype
        result = attenuate(sig_2d.astype(np.int64), 0)
        self.assertTrue(len(result) == len(sig_2d))
        self.assertTrue(result.shape == sig_2d.shape)
        self.assertTrue(result.dtype == np.int64)
    ...
    def test_values(self):
        ...
        self.assertTrue(np.allclose(result, 3.1622777 * sig_1d))
        # same with int dtype
        result = attenuate(sig_1d.astype(np.int64), 0)
        self.assertTrue(np.allclose(result, sig_1d.astype(np.int64)))
        result = attenuate(sig_1d.astype(np.int64), 5)
        self.assertTrue(np.allclose(result, 0 * sig_1d))
        # multi-channel signals
        result = attenuate(sig_2d, 0)
        self.assertTrue(np.allclose(result, sig_2d))
...
class TestMixFunction(unittest.TestCase):
    ...
    mono_2d = np.asarray([0.5, 0, 1, 0, 0.5, 0.5, 0.5, 0, 1], dtype=np.float64)
    ...
    def test_types(self):
        ...
        self.assertTrue(result.dtype == sig_1d.dtype)
        # same as int dtype
        result = remix(sig_1d.astype(np.int64), 1)
        self.assertTrue(len(result) == len(sig_1d))
        self.assertTrue(result.shape == sig_1d.shape)
        self.assertTrue(result.dtype == np.int64)
        result = remix(sig_1d.astype(np.int64), 2)
        self.assertTrue(len(result) == len(sig_1d))
        self.assertTrue(result.shape == (len(sig_1d), 2))
        self.assertTrue(result.dtype == np.int64)
        # from file
        ...
        with self.assertRaises(NotImplementedError):
            remix(sig_2d, 3)
        # same as int dtype
        result = remix(sig_2d.astype(np.int64), 1)
        self.assertTrue(len(result) == len(sig_2d))
        self.assertTrue(result.shape == sig_1d.shape)
        self.assertTrue(result.dtype == np.int64)
        result = remix(sig_2d.astype(np.int64), 2)
        self.assertTrue(len(result) == len(sig_2d))
        self.assertTrue(result.shape == sig_2d.shape)
        self.assertTrue(result.dtype == np.int64)
    ...
    def test_values(self):
        ...
        # same as int dtype
        result = remix(sig_2d.astype(np.int64), 1)
        self.assertTrue(np.allclose(result, self.mono_2d.astype(np.int64)))
        # multi-channel signals
        result = remix(sig_2d, 1)
        self.assertTrue(np.allclose(result, self.mono_2d))
        # same as int dtype
        result = remix(2 * sig_2d.astype(np.int64), 1)
...
class TestRescaleFunction(unittest.TestCase):
    ...
    def test_types(self):
        # mono signals
        result = rescale(sig_1d, np.float64)
        self.assertTrue(len(result) == len(sig_1d))
        self.assertTrue(result.shape == sig_1d.shape)
        ...
        # from file
        signal = Signal(stereo_sample_file)
        result = rescale(signal, np.float64)
        self.assertTrue(isinstance(result, Signal))
        self.assertTrue(isinstance(result, np.ndarray))
        self.assertTrue(result.dtype == np.float64)
...
class TestSignalFrameFunction(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertIsInstance(result, np.ndarray)
        self.assertTrue(result.dtype == np.int64)
        result = signal_frame(np.arange(10, dtype=np.float64), 0, 4, 2)
        self.assertIsInstance(result, np.ndarray)
        self.assertTrue(result.dtype == np.float64)
        signal = Signal(sample_file)
