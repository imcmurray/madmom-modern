...
class TestTransitionModelClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertTrue(self.tm.probabilities.dtype == np.float64)
        self.assertTrue(self.tm.log_probabilities.dtype == np.float64)
...
class TestDiscreteObservationModelClass(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertTrue(self.om.densities(OBS_SEQ).dtype == np.float64)
        self.assertTrue(self.om.log_densities(OBS_SEQ).dtype == np.float64)
