...
class TestFindClosestMatchesFunction(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertEqual(matches.dtype, np.int64)
...
class TestCalcErrorsFunction(unittest.TestCase):
    ...
    def test_types(self):
        ...
        self.assertEqual(errors.dtype, np.float64)
...
class TestEvaluationClass(unittest.TestCase):
    ...
    def test_results(self):
        ...
        tp = np.asarray([1, 2, 3], dtype=np.float64)
        self.assertTrue(np.allclose(e.tp, tp))
        fp = np.asarray([1.5], dtype=np.float64)
        self.assertTrue(np.allclose(e.fp, fp))
        tn = np.asarray([], dtype=np.float64)
        self.assertTrue(np.allclose(e.tn, tn))
        fn = np.asarray([0, 3.1], dtype=np.float64)
